...
export default function Feed() {
    ...
    async function getAllFeeds() {
        ...
        try {
            const respAllFeeds = await axios.get('https://twitter-backend-7a5d.onrender.com/api/vt1/allt', {
    ...
    async function tweetAdd() {
        ...
        try {
            ...
            const respTweetAdd = await axios.post('https://twitter-backend-7a5d.onrender.com/api/vt1/t', formData, {
