...
export default function Profile() {
    ...
    async function getUserDetails() {
        ...
        try {
            const respDetails = await axios.get(`https://twitter-backend-7a5d.onrender.com/api/vt1/p/${userName}`, {
    ...
    async function editUserDetail(event) {
        ...
        const token = localStorage.getItem('myToken');
        try {
            const respEditedUser = await axios.post('https://twitter-backend-7a5d.onrender.com/api/vt1/e', editProfile, {
                headers: { "Authorization": "Bearer " + token }
            });
    ...
    async function followTheUser(userName) {
        const token = localStorage.getItem('myToken');
        try {
            const respFollow = await axios.get(`https://twitter-backend-7a5d.onrender.com/api/vt1/follow/${userName}`, {
                headers: { "Authorization": "Bearer " + token }
            });
            if (respFollow.data) {
                sweetAlert.fire({
    ...
    async function profilePhoto() {
        ...
        try {
            ...
            const respProfilePhoto = await axios.post('https://twitter-backend-7a5d.onrender.com/api/vt1/pic', formData, {
                headers: { "Authorization": "Bearer " + token }
            });
